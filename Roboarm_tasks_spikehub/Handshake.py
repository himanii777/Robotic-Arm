...
def do_task():
    ...
    pose("half_close", {"wrist": HANDSHAKE_WRIST}, 0.65)

    for angle in (-18, 18, -14, 14, 0):
        move_to({"yaw": angle, "wrist": HANDSHAKE_WRIST}, 0.32)

    pose("open_hand", {"yaw": 0, "wrist": DEFAULT_WRIST}, 0.45)
    pose("thumbs_up", {"wrist": THUMBS_UP_WRIST}, 0.55)

    for angle in (-12, 12, 0):
        move_to({"yaw": angle}, 0.28)
